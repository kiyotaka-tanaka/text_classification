...
parser.add_argument("--input_text",help="classify text",type=str, default="日本でビジネスをする")
parser.add_argument("--path_to_model",help="model path",type=str, default ="")
...
node = mecab.parseToNode(args.input_text)
while node:
    word = node.surface
    node = node.next
